...
Eval runner + scoring + portable cross-model bundle DROPPED to documentation only (per user). Durable outputs complete: research in docs/tui-style-eval.md + validated encoders in-tree (moving to the toque crate under yaksrs-20b9). Approaches + rough results will also seed toque's README.
